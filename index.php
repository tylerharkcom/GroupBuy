  ...
  <html lang="en" dir="ltr">
    ...
    <body>
      ...
      <div class="container">
        ...
        <h1>Welcome to the Shopping Application Project for COP 4710, <?php echo $_SESSION['firstName'] ?>.</h1>
        <h3>Please use the links in the navigation bar to access different parts of the system.</h3>
